...
public class CustomViewAbove extends ViewGroup {
	...
	public void setAboveTransformer(CanvasTransformer transformer) {
	...
	protected float getAbovePercentOpen() {
		return Math.abs(mScrollX - mContent.getLeft()) / (getBehindWidth() * 2f);
	}
	...
	protected void dispatchDraw(Canvas canvas) {
		if (mTransformer != null) {
			...
			float percent = 1 - getAbovePercentOpen();
