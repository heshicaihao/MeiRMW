...
package com.sina.weibo.mysdk.widget;
...
import com.sina.weibo.mysdk.openapi.LogoutAPI;
...
public class LoginoutButton extends Button implements OnClickListener {
	 ...
	 * <p>
	 * 重要：使用该控件的 Activity 必须重写 {@link Activity#(int, int, Intent)}，onActivityResult
	 ...
	 * }
	 * </pre>
	 * @param requestCode 请查看 {@link Activity#(int, int, Intent)}onActivityResult
	 * @param resultCode  请查看 {@link Activity#(int, int, Intent)}onActivityResult
	 * @param data        请查看 {@link Activity#(int, int, Intent)}onActivityResult
	 */
