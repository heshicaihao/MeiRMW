...
package com.sina.weibo.mysdk.codestyle;
 ...
 *    <h3>5.2. 细则</h3>
 *    <ul>
 *         <li>5.2.1. 条件表示式，参见 {@link #(boolean)} conditionFun
// *         <li>5.2.2. switch 语句，参见 {@link #(int)}switchFun
// *         <li>5.2.3. 循环语句，参见 {@link #(boolean)}circulationFun
